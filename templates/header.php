...
<body>
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3b9eb6">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-light" href="../admin/index.php">Админка сайта</a>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0" action="../elem/search.php?search=<?=$_GET['search'] ?? ''?>">
